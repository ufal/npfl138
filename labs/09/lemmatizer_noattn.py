...
class Dataset(npfl138.TransformedDataset):
    ...
    def collate(self, batch):
        ...
        # TODO: `words` is a list of lists of strings. Flatten it into a single list of strings
        ...
        lemmas = ...
        # TODO: Return an (inputs, targets) pair, where
...
class Model(npfl138.TrainableModule):
    def __init__(self, args: argparse.Namespace, train: MorphoDataset.Dataset) -> None:
        ...
        # Create self._target_rnn_cell, which is a single cell of `self._target_rnn`.
        ...
        if not args.tie_embeddings:
            # TODO: Define `self._target_embedding` as an embedding layer of the target
    ...
    def encoder(self, words: torch.Tensor) -> torch.Tensor:
        ...
        # padding. The result should be the last hidden state of the forward and the
    ...
    def decoder_prediction(self, encoded: torch.Tensor, max_length: int) -> torch.Tensor:
        ...
        # - `states`: the initial RNN state from the encoder, i.e., `encoded`.
