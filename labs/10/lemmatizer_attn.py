...
def main(args: argparse.Namespace) -> dict[str, float]:
    ...
    def prepare_tagging_data(example):
        # TODO(lemmatizer_noattn): Return `example["forms"]` as inputs and `example["lemmas"]` as targets.
    ...
    def prepare_batch(data, training: bool):
        ...
        # TODO(lemmatizer_noattn): The `forms` are a list of list of strings. Flatten it into a single list of strings
    ...
    model.configure(
        ...
        optimizer=...,
        # TODO(lemmatizer_noattn): Use `torch.nn.CrossEntropyLoss` to instantiate the loss function.
