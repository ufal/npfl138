...
"""The [MNIST dataset](https://en.wikipedia.org/wiki/MNIST_database) consists of
28x28 grayscale images of handwritten digits, along with their labels.

The dataset is split into:

- `train`: 55,000 images for training;
