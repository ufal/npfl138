...
for the [20×20×20](https://ufal.mff.cuni.cz/~straka/courses/npfl138/2526/demos/modelnet20.html)
and the [32×32×32](https://ufal.mff.cuni.cz/~straka/courses/npfl138/2526/demos/modelnet32.html)
resolutions.

Each dataset element is a Python dictionary with the following keys:

- `"grid"`: a `torch.Tensor` with shape `[1, 20, 20, 20]` or `[1, 32, 32, 32]` of type `torch.uint8`
  with values 0 or 1 indicating whether the corresponding voxel is empty or occupied by the object,
...
if __name__ == "__main__":
    ...
    if args.evaluate:
        ...
        print(f"ModelNet accuracy: {100 * accuracy:.2f}%")
