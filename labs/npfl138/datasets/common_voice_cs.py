...
You can repeat this preprocessing on a given audio using the [load_audio][npfl138.datasets.CommonVoiceCs.load_audio]
and [extract_mfcc][npfl138.datasets.CommonVoiceCs.mfcc_extract] methods.
