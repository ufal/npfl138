...
class Model(npfl138.TrainableModule):
    ...
    def compute_loss(self, y_pred: torch.Tensor, y_true: torch.Tensor, word_ids: torch.Tensor) -> torch.Tensor:
        ...
        #   - This is because we want to compute averages per logit; `torch.nn.CTCLoss` does
    ...
    def ctc_decoding(self, logits: torch.Tensor, word_ids: torch.Tensor) -> list[torch.Tensor]:
        # TODO: Implement the greedy CTC decoding algorithm. The result should be a list of
    ...
    def compute_metrics(
        ...
        # TODO: Compute predictions using `ctc_decoding`.
        predictions = ...
...
def main(args: argparse.Namespace) -> dict[str, float]:
    ...
    model.configure(
        ...
        optimizer=...,
        # We compute the loss using the `compute_loss` method, so no `loss` is passed here.
        metrics={
            # TODO: Create `npfl138.metrics.EditDistance` with `ignore_index=morpho.PAD`,
            # evaluating the greedy CTC decoding.
            "edit_distance": ...,
        },
