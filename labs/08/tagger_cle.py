...
class Model(TrainableModule):
    ...
    def __init__(self, args: argparse.Namespace, train: MorphoDataset.Dataset) -> None:
        ...
        # word embeddings, **now concatenated with the character-level embeddings**, and produces
        # output of dimensionality `args.rnn_dim`; pass `batch_first=True` to the constructor.
        self._word_rnn = ...
