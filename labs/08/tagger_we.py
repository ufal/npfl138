...
class Model(TrainableModule):
    def __init__(self, args: argparse.Namespace, train: MorphoDataset.Dataset) -> None:
        ...
        # word embeddings and produces output of dimensionality `args.rnn_dim`.
        # Finally, pass `batch_first=True` to the constructor.
        self._word_rnn = ...
...
def main(args: argparse.Namespace) -> dict[str, float]:
    ...
    def prepare_batch(data):
        ...
        # TODO: Combine `form_ids` into a single tensor, padding shorter
