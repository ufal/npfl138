...
class Model(npfl138.TrainableModule):
    ...
    def forward(self, word_ids: torch.Tensor) -> torch.Tensor:
        # TODO: Start by embedding `word_ids` using the word embedding layer.
        hidden = ...
        ...
        # TODO: Unpack the RNN output using `torch.nn.utils.rnn.pad_packed_sequence` with the
        # `batch_first=True` argument. Then sum the outputs of the forward and backward directions.
        hidden = ...

        # TODO: Pass the RNN output through the output layer. Such an output has shape
