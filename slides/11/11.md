...
![w=33%,h=center](../10/transformer.png)
...
![w=72%,v=middle](../10/illustrated_transformer_decoder.png)![w=28%](../10/transformer.png)

---
# Transformer – Decoder

![w=28%,f=right](../10/transformer.png)
...
As of April 2024, the current second best model on ImageNet is BASIC-L trained with
