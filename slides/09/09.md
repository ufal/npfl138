...
~~~
  - Sentence-piece model splits at Unicode codepoint boundaries, but can represent
    unknown characters using bytes of UTF-8 encoding. **Gemini**
~~~
...
Both the BPE and the WordPieces were being used originally; the biggest
...
~~~
Nowadays, most large laguage models have adopted the BPE approach.
